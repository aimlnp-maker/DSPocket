...
class MolPredict(object):
    ...
    def __init__(self, load_model=None, protein_path='./Data/PDB/repr'):
        """ 
        ...
        self.config.protein_path = protein_path
        self.task = self.config.task
        self.target_cols = self.config.target_cols
        test_metric = joblib.load(os.path.join(load_model, "metric.result"))
        logger.info("Test Metrics: {}".format(test_metric))
